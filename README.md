...
Начинающая фронтенд-разработчица. В обучении выбрала стратегию изучить хорошо ванильный JS, поэтому для меня происходящее в React, Redux и в других библиотеках не является магией.

Ранее 3,5 года работала разработчицей на Oracle Siebel CRM. В последний год в качестве тимлида. Разрабатывала и внедряла CRM-системы на крупных банковский проектах. Решила сменить профессию, потому что всегда хотела именно кодить и работать в разных it сферах.

Мне хочется делать сложные веб-приложения, которые бы нравились пользователям. Фронтенд это буквально лицо продукта, поэтому для меня важно находить подходящие решения для разработки новых фич или устранения проблем, и думать головой, а не слепо выполнять таски.

Буду рада развиваться в fullstack-разработке и готова изучать другие фреймворки.
...
CLI программа на ванильном JS: вычислитель отличий между файлами формата JSON и/или YML. Так же можно подключить как библиотеку. Покрыта тестами (jest).
...
|Выступала продукт менеджером для внутренней разработки программы, который помогал разработке быстрее выполнять рутинные задачи.|На своей шкуре испытала весь цикл разработки. Начиная с постановки задач, заканчивая тестированием и фидбеком от пользователей. Вижу в процессах команды рутинные вещи, которые можно автоматизировать.|
...
Люблю плавать и в холодное время года хожу в бассейн. Частенько посещаю театр и с удовольствием могу посоветовать спектакль. Недавно увлеклась историей и экономикой: читаю книги и слушаю лекции. Страюсь вести экологичный образ жизни и мечтаю сделать приложение на эту тему :)
