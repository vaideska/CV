...
Фронтенд-разработчик с опытом разработки сложных клиентских систем.
Для меня важен разрабатываемый продукт и качество пользовательского опыта. Мне нравится работать с вовлеченными людьми, так как сама являюсь проактивным членом команды.
Активно развиваю t-shape компетенции и ищу более сложные и интересные проекты.
...
| TypeScript             | Eslint                     |Agile           |
| Redux, Redux-Toolkit   | VSCode                     |JIRA, Confluence|
| Zustand                |                            |                |
| HTML                   |                            |                |
| CSS                    |                            |                |
| DOM API                |                            |                |
...
`TypeScript` `React` `Zustand` `SASS` `Ant Design`

Разработала с нуля веб-приложение личного кабинета для инвесторов. На старте проекта была единственной разработчиком, тесно общалась с бизнесом, принимала архитектурные и UX решения, участвовала в проектировании API. В рамках работы на проекте удалось поработать с веб-сокетами и локализацией, реализовать логин, авторизацию и вложенный роутинг
...
Дорабатывала [конструктор ботов](https://www.amocrm.ru/support/digital_pipline/salesbot), с помощью которых пользователи CRM могут автоматизировать ответы клиентам, выполнять действия со сделками, создавать анкеты и многое другое.
Быстро разобралась в новых для себя технологиях, как Backbone.js и twig-шаблоны.
Проводила код-ревью джуниоров.

## Яндекс.Практикум (part time)
Май 2022 — Июль 2022 
#### Code Reviewer (Frontend developer)

Проводила код-ревью проектных работ по JavaScript студентов Яндекс.Практикума направления фронтенд разработки.
...
Основной язык программирования для изучения и решения прикладных задач был C++. Бакалаврская и магистерская дипломные работы были написаны на темы ускорений решений алгоритмических задач: о максимальной клике и задачи о коммивояжере. Один из алгоритмов приближенного решения был запатентован в соавторстве с научным руководителем.
