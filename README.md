...
Я фронтенд-разработчица, которая стремится стать настоящим инженером. Я очень люблю JavaScript и для меня первостепенно изучение программирования, а не фреймворки и инструменты.
