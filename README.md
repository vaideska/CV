...
Я фронтенд-разработчица с коммерческм опытом в IT в другой сфере. В обучении выбрала стратегию изучить хорошо JavaScript, поэтому для меня происходящее в React, Redux и в других библиотеках не является магией.
...
Провожу код-ревью проектных работ по JavaScript студентов Яндекс.Практикума по направлению фронтенд разработки.
